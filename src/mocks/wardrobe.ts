...
export const mockWardrobeItems = [
  {
    id: "item-001",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/6e4ae0/white?text=White+Tee",
  ...
  },
  {
    id: "item-002",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/1e1b2e/white?text=Black+Jeans",
  ...
  },
  {
    id: "item-003",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/9f7ef5/white?text=Floral+Dress",
  ...
  },
  {
    id: "item-004",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/ff9f7c/white?text=Leather+Jacket",
  ...
  },
  {
    id: "item-005",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/00c9b7/white?text=Sneakers",
  ...
  },
  {
    id: "item-006",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/6b667b/white?text=Wool+Scarf",
  ...
  },
  {
    id: "item-007",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/1e1b2e/white?text=Navy+Blazer",
  ...
  },
  {
    id: "item-008",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/9f7ef5/white?text=Silk+Blouse",
  ...
  },
  {
    id: "item-009",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/ff9f7c/white?text=Khaki+Chinos",
  ...
  },
  {
    id: "item-010",
    userId: "user-123",
    imageUrl: "https://placehold.co/600x800/00c9b7/white?text=Summer+Hat",
...
export const mockWardrobeApi = {
  ...
  addItem: async (_formData: FormData) => {
    ...
    const newItem = {
      id: `item-${Date.now()}`,
      userId: "user-123",
      imageUrl: "https://placehold.co/600x800/6e4ae0/white?text=New+Item",
